...
<title>Card Insert Page</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Home</title>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="css/cardinsert.css" />
...
<!--   <div class="headersection">
        ...
        <div class="productsection">
            ...
            <br>
            <center><h2 style="color: white">Enter your card detsils</h2></center>
            </div>
            <br>
	...
	<form action="cardinsert" method="post">
		...
		<input type="submit" class = "reg" name="submit" value="Add Card"> 
		<input type="reset" class = "reg" name="cancel" value="Clear Details">
	</form>
	 </div>
	</div>
	...
	<form action="cardinsert" method="post">
		<div class="user-box">
		Card Number <input type="text" name="cardnumber" placeholder="xxxx-xxxx-xxxx-xxxx"  pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{4}" required>
		...
		<button class="button" type="reset" style="background-color: #f44336">Clear Details</button>
		
		<!--  
		<input type="submit" name="submit" value="Add Card"> 
		<input type="reset" name="cancel" value="Clear Details">
