        ...
        <div class="bodysection">
            ...
            <div class="contactcontainer">
                <div class="contacttext">
                    ...
                    <br><br>
                    <p>Your comments and inquiry are important to us, and we will do our best to react to you as soon as possible. Your input will assist us in continually improving ourselves to better serve you and our other loyal customers.</p>
                    <br><br>
                    <div class="contactbox">
                        <br><br><br>
                        <i class="fa fa-phone" style="font-size:48px;"></i>
                        <br><br>
                        <h2 style="color: white ; font-family: Arial, Helvetica, sans-serif;">Telephone</h2>
                        <br>
                        <p style="color: white ;">+94 112303500</p>
                    </div>
                    <div class="contactbox2">
                        <br><br><br>
                        <i class="fa fa-envelope" style="font-size:48px; color: white;"></i>
                        <br><br>
                        <h2 style="color: white ; font-family: Arial, Helvetica, sans-serif;">Email</h2>
                        <br>
                        <p style="color: white ;">customercare@onestop.lk</p>
                    </div>
                    <div class="contactbox3">
                        <br><br><br>
                        <i class="fa fa-fax" style="font-size:48px; color: white;"></i>
                        <br><br>
                        <h2 style="color: white ; font-family: Arial, Helvetica, sans-serif;">Fax</h2>
                        <br>
                        <p style="color: white ;">+94 112303555</p>
                    </div>
                </div>
            </div>
