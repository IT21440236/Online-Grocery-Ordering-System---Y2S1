...
<body>
	...
	<form action="cardupdate" method="post">
			...
			<label class="cd">Card Number</label>
			<br>
			...
			<label class="cd">Expiry Date</label>
			<br>
			<input type="text" name="date" value="<%=expiryDate %>">
			<br><br>
			...
			<br>
			<input type="text" name="name" value="<%=cardholderName %>">
			<br><br>
		...
		<input  type="submit" class = "updatebtn" name="submit" value="Update My Card"> <br>
	</form>
	</div>
    </div>
	</div>
