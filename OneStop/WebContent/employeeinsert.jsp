...
<meta charset="UTF-8" />
        ...
        <link rel="stylesheet" href="css/employeeinsert.css" />
...
<body>
	...
	<div class="headersection">
        ...
        <div class="productsection">
            ...
            <br>
            <center><h2 style="color: white">Create your admin account</h2></center>
            </div>
            <br>
			...
			<form action= "inserts" method = "post">
                ...
                <br>
            <input  class = "reg" type = "submit" name= "submit" value="Create Employee">
            </form>
            </div>
            </div>
