	...
	<div class="headersection">
        ...
        <div class="bodysection">
            ...
            <a href="paymentinsert.jsp">
                <input  type="button" class="userbtn" name="cart" value="Proceed to checkout">
            </a>

            <a href="foodandmeat.jsp">
                <input  type="button" class="userbtn" name="cart" value="Continue Shopping">
            </a>
