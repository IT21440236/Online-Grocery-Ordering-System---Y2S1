...
<title>Insert title here</title>
	<meta charset="UTF-8" />
        ...
        <link rel="stylesheet" href="css/customerloginsecond.css" />
...
<body>
	<div class="headersection">
        ...
        <div class="logimg">
                <img src="images\index3.jpg" height="670px">
            </div>
        <div class="login">
        	<div class = "loginheader">
        	<br>
           <center> <h3 style="color: white">Hello Welcome Back! Please Login using your email and password.</h3></center>
            </div>
            <br>           
            <form action="log" method= "post"> 
                Email <input type="text" name="eid"><br><br>
