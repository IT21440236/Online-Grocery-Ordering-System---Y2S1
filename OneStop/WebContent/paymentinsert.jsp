...
<title>Insert Payment</title>
        ...
        <link rel="stylesheet" href="css/paymentinsert.css" />
...
<body>
	...
	<div class="headersection">
        ...
        <div class="productsection">
            ...
            <br>
            <center><h2 style="color: white">Enter Payment Details</h2></center>
            </div>
            <br>
			<form action="paymentinsert" method="post">
                ...
                Amount Rs. <input type="text" name="amount"> <br><br>
                
                <input type="submit" class = "reg" name="submit" value="Make Payment">
                <input type="reset" class = "reg" name="cancel" value="Cancel Payment">
            </form>
            <div class="cardline">
            ...
            <div class="bgimg">
                <img src="images\payment1.jpg" height="710px">
            </div>
        </div>
