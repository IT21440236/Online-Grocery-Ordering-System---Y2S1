...
<body>
        ...
        <div class="bodysection">
            ...
            <div class="registorbox">
                <br>
                <center><h4 style="color: white">Already Registered</h4></center>
                <br>
                <center><a href="customerlogin.jsp" style="color: white">Login Here</a></center>
                
            </div>
            <div class="registorbox1">
                <br>
                <center><h4 style="color: white">New to store</h4></center>
                <br>
                <center><a href="customerinsert.jsp" style="color: white">RegisterHere</a></center>
            </div>
            <div class="registorbox2">
                <br>
                <center><h4 style="color: white">Browse The Store</h4></center>
                <br>
                <center><a href="home.jsp" style="color: white">Click Here</a></center>
            </div>
