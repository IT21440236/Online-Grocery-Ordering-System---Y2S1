...
<body>
	...
	<form action="deletes" method= "post">
			...
			<label class="cd">Employee ID</label>
            <br>
			<input type="text" name = "empid" value= "<%=eid %>" readonly>
            <br><br>
	
			<label class="cd">Username </label>
            <br>
			<input type="text" name = "username" value= "<%=username %>"readonly>
            <br><br>
	
			<label class="cd">Email </label>
            <br>
			<input type="text" name = "email" value= "<%=email %>"readonly>
            <br><br>

			<label class="cd">Phone </label> 
            <br>
            ...
            <br>  
			<input type="text" name = "passw" value= "<%=password %>"readonly>
	
	<br><br><br>
	
	<input class = "" type = "submit" name= "submit" value= "Delete My Data"><br>
	</form>
	</div>
    </div>
