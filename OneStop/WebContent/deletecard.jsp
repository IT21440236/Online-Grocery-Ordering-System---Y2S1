...
<title>Insert title here</title>
	<meta charset="UTF-8" />
        ...
        <link rel="stylesheet" href="css/customerdelete.css" />
...
<body>
	...
	<div class = "userupdatesection">
        <h1 >Edit Card Details</h1><br>
	
	<form action="deletecard" method="post">
		
		
		
			<labelclass="cd">Card Number</label>
			 <br>
			<input type="text" name="cardnumber" value="<%= cardNumber%>" readonly></td>
			 <br> <br>
		
		
			<label class="cd">Expiry Date</td>
			 <br>
			<input type="text" name="date" value="<%=expiryDate %>" readonly>
			 <br> <br>
		
		
			<label class="cd">CVV</label>
			 <br>
			<input type="text" name="cvv" value="<%=cvv %>" readonly>
		
		
			<label class="cd">Cardholder name</label>
			<input type="text" name="name" value="<%=cardholderName %>" readonly>
		 	<br> <br>
		
		
			<label class="cd">Password</label>
			 <br>
		...
		<br><br><br>
		<input type="submit" class = "updatebtn" name="submit" value="Delete My Card"> <br>
	</form>
	</div>
    </div>
	</div>
