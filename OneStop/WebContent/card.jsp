...
<!--  	<div class="headersection">
 ...
 <!--        <div class="login">
        	...
        	<br>
           <center> <h3 style="color: white">Enter Your Card Number and Password</h3></center>
            </div>
            <br>
	...
	<form action="card" method ="post">
		...
		<input type="submit" class ="log" name="submit" value="View Card">
	</form>
	</div> --> 
	...
	<form action="card" method ="post">
		<div class="user-box">
		<input type="text" name="cardnumber"  pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{4}" required>
	 ...
	 <a href="carddetail.jsp">
     	<span></span>
     	 <span></span>
      	<span></span>
      	<span></span>
		<button class="button"  type="submit">View Card</button>
	</a>
		 <!-- <input type="submit" name="submit" value="View Card"> --> 
	</form>
	</div>
